...
const About = () => (
  <div>
    ...
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <motion.p
          ...
          className="text-primary-foreground/50 italic text-sm mb-8 tracking-[0.3em] uppercase"
        >
        ...
        >
          <div className="md:col-span-2 flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 md:w-72 md:h-72 rounded-2xl overflow-hidden shadow-2xl border-2 border-secondary/20">
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <div className="md:col-span-3 order-2 md:order-1">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold mt-2 mb-2">Smt. Revathi Ramachandran</h2>
            <div className="w-12 h-0.5 bg-primary rounded-full mb-6" />
            <blockquote className="border-l-4 border-primary/40 pl-6 italic text-foreground/70 mb-6 leading-relaxed text-lg">
          ...
          <div className="md:col-span-2 flex justify-center order-1 md:order-2">
            <div className="relative">
              <div className="w-64 h-64 md:w-72 md:h-72 rounded-2xl overflow-hidden shadow-2xl border-2 border-primary/20">
    ...
    <section className="relative w-full h-72 md:h-96 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[hsl(0_69%_10%/0.85)] via-[hsl(0_0%_0%/0.3)] to-transparent flex items-end justify-center pb-10">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div className="w-16 h-0.5 bg-secondary mx-auto mb-4 rounded-full" />
          <h3 className="font-serif text-3xl md:text-4xl text-primary-foreground font-bold" style={{ textShadow: "0 2px 20px hsl(0 0% 0% / 0.6)" }}>
            Our Leadership
          </h3>
        </motion.div>
      </div>
    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 max-w-3xl text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
          ...
          <h2 className="font-serif text-3xl md:text-5xl font-bold mb-4 text-primary-foreground">Our Philosophy</h2>
          <h3 className="font-serif text-xl text-shimmer-gold font-semibold mb-6">The Guru-Shishya Parampara</h3>
          <p className="text-primary-foreground/75 leading-relaxed mb-6 text-lg">
