    ...
    <div>
      ...
      <section ref={heroRef} className="relative min-h-[55vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <motion.p initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} <motion.p initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="font-devanagari text-4xl md:text-6xl lg:text-7xl text-shimmer-gold mb-4 leading-relaxed overflow-visible py-2">>
            नादो उपासना
          </motion.p>
