...
const actionColors: Record<string, string> = {
  ...
  "course.deleted": "bg-destructive/10 text-destructive",
  "course.submitted": "bg-yellow-100 text-yellow-700",
  ...
  "assignment.deleted": "bg-destructive/10 text-destructive",
  ...
  "coupon.created": "bg-blue-100 text-blue-700",
  "coupon.deleted": "bg-destructive/10 text-destructive",
  "coupon.toggled": "bg-yellow-100 text-yellow-700",
  "job.created": "bg-blue-100 text-blue-700",
  "job.updated": "bg-primary/10 text-primary",
  "job.deleted": "bg-destructive/10 text-destructive",
  "job.toggled": "bg-yellow-100 text-yellow-700",
  "event.created": "bg-blue-100 text-blue-700",
  "event.updated": "bg-primary/10 text-primary",
  "event.deleted": "bg-destructive/10 text-destructive",
  "category.created": "bg-blue-100 text-blue-700",
  "category.updated": "bg-primary/10 text-primary",
  "category.deleted": "bg-destructive/10 text-destructive",
  "volunteer.submitted": "bg-blue-100 text-blue-700",
  "volunteer.status_updated": "bg-yellow-100 text-yellow-700",
  "inquiry.submitted": "bg-blue-100 text-blue-700",
  "inquiry.status_updated": "bg-yellow-100 text-yellow-700",
  "inquiry.deleted": "bg-destructive/10 text-destructive",
