    ...
    <div className="space-y-6 pt-2">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl bg-card p-5 shadow-[0_2px_16px_hsl(var(--primary)/0.06)]">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="text-xs text-muted-foreground">Account actions are in the Account &amp; Access tab</p>
        </div>
      </motion.div>
      ...
      <Tabs defaultValue="personal">
        <TabsList className="rounded-xl">
          ...
          <TabsTrigger value="account" className="gap-1.5"><Shield className="h-4 w-4" /> Account &amp; Access</TabsTrigger>
        ...
        <TabsContent value="academic" className="mt-4 space-y-4">
          <div className="grid gap-3 rounded-2xl bg-card p-5 shadow-[0_2px_16px_hsl(var(--primary)/0.06)] sm:grid-cols-2">
            ...
            {userRole === "instructor" && (
              <>
                <h3 className="sm:col-span-2 font-serif text-lg text-primary">Faculty Details</h3>
